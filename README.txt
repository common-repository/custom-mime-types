...
Tags: mimes, mime types, customize mimes, file, upload, file size, upload size, maximum, role, extentions, file type
...
🔄 **[AjaxPress](https://wordpress.org/plugins/ajaxpress/)**  - AjaxPress is a simple tool that turns your website into Single Page Application, with no loading features.
